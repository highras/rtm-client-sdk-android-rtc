~~~ c++
     ...
     */
    public void kickout(String endpoint, final IRTMEmptyCallback callback)
     ...
     */
    public void addAttributes(Map<String, String> attrs, final IRTMEmptyCallback callback)
     ...
     * @param attrs     消息属性信息
     */
    public void addDebugLog(String message, String attrs， IRTMEmptyCallback callback) 
     ...
     */
    public void addDevice(String appType, String deviceToken, IRTMEmptyCallback callback) 
     ...
     * @param deviceToken   设备token(NoNull)
     */
    public void removeDevice(String deviceToken, final IRTMEmptyCallback callback)
     ...
     */
    public void setUserInfo(String publicInfo, String privateInfo, IRTMEmptyCallback callback)
     ...
     * @param uids     用户uid集合
     */
    public void getUserPublicInfo(HashSet<Long> uids, final IRTMCallback<Map<String, String>> callback)
     ...
     * @return  RTMAnswer
     */
    public RTMAnswer addDevicePushOption( int type,  long xid, HashSet<Integer> messagetTypes)
     ...
     * @return  RTMAnswer
     */
    public RTMAnswer removeDevicePushOption( int type,  long xid, HashSet<Integer> messagetTypes)
     ...
     * @return  RTMAnswer
     */
    public void addDevicePushOption(int type,  long xid, HashSet<Integer> messagetTypes, UserInterface.IRTMEmptyCallback callback)
     ...
     * @return  RTMAnswer
     */
    public void removeDevicePushOption(int type,  long xid, HashSet<Integer> messagetTypes, UserInterface.IRTMEmptyCallback callback)
