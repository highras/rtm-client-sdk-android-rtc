...
public class MainActivity extends AppCompatActivity {
    ...
    class RTMExampleQuestProcessor extends RTMPushProcessor {
        ...
        public boolean reloginWillStart(long uid, RTMStruct.RTMAnswer answer, int reloginCount) {
            if (reloginCount >= 10) {return false;}
...
//                                    MainActivity.this.checkVersion();
    ...
    public  String getTokennx() {
        String token = "";
        try {
            URL urlObject = new URL("http://161.189.171.91:8090/?uid=" + uid);
            ...
            e.printStackTrace();
            Log.e("sdktest","connect error " + e.getMessage());
        }
        return token;
    }
